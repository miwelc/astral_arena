...
const MAP_VISUAL_PROFILES = deepFreeze({
  'crater-ridge': {
    ...
    backgroundColor: 0x24464f,
    fog: { color: 0x729a98, density: 0.0035 },
    exposure: 1.05,
    environmentIntensity: 1,
    lighting: {
      ambient: { color: 0x8aa58c, intensity: 0.3 },
      hemisphere: { skyColor: 0xc7ebdc, groundColor: 0x516a4d, intensity: 0.92 },
      sun: {
        color: 0xffdfad,
